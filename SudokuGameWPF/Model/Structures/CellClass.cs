...
namespace SudokuGameWPF.Model.Structures
{
    public class CellClass : INotifyPropertyChanged
    {
        ...
        private NoteState[] notes = new NoteState[9];              // Array to hold the state of the notes for this cell.
        private Int32 userAnswer;                                  // Holds the user's answer.
        private CellStateEnum cellState;                           // Holds the state of this cell.
        private CellSelection cellSelection;                       // Holds the Selection of this cell
        ...
        public CellStateEnum CellState
        {
            ...
            set
            {
                cellState = value;                     // Save the new state.
        ...
        public CellSelection CellSelection
        {
            ...
            set
            {
                cellSelection = value;                     // Save the new selection.
                OnPropertyChanged();                    // Raise a property changed event.
            }
        }
        ...
        public Int32 UserAnswer
        {
            ...
            set
            {
                ...
                {
                    userAnswer = value;                                    // Yes, save it.
                    if (userAnswer == Answer)                              // Is the user's answer correct?
        ...
        private void InitCell()
        {
            ...
            CellSelection = CellSelection.Nothing;              //Initialize the cell's selection to Nothing.
