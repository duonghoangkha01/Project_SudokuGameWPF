...
namespace SudokuGameWPF.ViewModel.GameGenerator
{
    internal class MaskPuzzle
    {
        ...
        private Int32 cMaxInterations = 10;    // Maximum number of iterations before we give up.
        ...
        internal void MaskBoard(CellClass[,] cells)
        {
            ...
            Int32 mask = 81 - GetMaskedValue(level);                           // Get the number of cells to mask based on the difficulty level.
            ...
            do
            {
                ...
                {                                                               // Not solvable
                    ...
                    if (numIterations > cMaxInterations)                       // Did we exceed the maximum iterations?
                    {
